...
public class GetAddressByZipCodeResponse  implements java.io.Serializable {
    private cn.nwafulive.webservice.postcode.GetAddressByZipCodeResponseGetAddressByZipCodeResult getAddressByZipCodeResult;

    public GetAddressByZipCodeResponse() {
    }

    public GetAddressByZipCodeResponse(
           cn.nwafulive.webservice.postcode.GetAddressByZipCodeResponseGetAddressByZipCodeResult getAddressByZipCodeResult) {
     ...
     */
    public cn.nwafulive.webservice.postcode.GetAddressByZipCodeResponseGetAddressByZipCodeResult getGetAddressByZipCodeResult() {
        return getAddressByZipCodeResult;
    }
     ...
     */
    public void setGetAddressByZipCodeResult(cn.nwafulive.webservice.postcode.GetAddressByZipCodeResponseGetAddressByZipCodeResult getAddressByZipCodeResult) {
        this.getAddressByZipCodeResult = getAddressByZipCodeResult;
    }
