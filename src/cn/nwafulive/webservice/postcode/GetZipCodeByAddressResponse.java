...
public class GetZipCodeByAddressResponse  implements java.io.Serializable {
    private cn.nwafulive.webservice.postcode.GetZipCodeByAddressResponseGetZipCodeByAddressResult getZipCodeByAddressResult;

    public GetZipCodeByAddressResponse() {
    }

    public GetZipCodeByAddressResponse(
           cn.nwafulive.webservice.postcode.GetZipCodeByAddressResponseGetZipCodeByAddressResult getZipCodeByAddressResult) {
     ...
     */
    public cn.nwafulive.webservice.postcode.GetZipCodeByAddressResponseGetZipCodeByAddressResult getGetZipCodeByAddressResult() {
        return getZipCodeByAddressResult;
    }
     ...
     */
    public void setGetZipCodeByAddressResult(cn.nwafulive.webservice.postcode.GetZipCodeByAddressResponseGetZipCodeByAddressResult getZipCodeByAddressResult) {
        this.getZipCodeByAddressResult = getZipCodeByAddressResult;
    }
