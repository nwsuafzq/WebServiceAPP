...
public class GetDomesticAirlinesTimeResponse  implements java.io.Serializable {
    private cn.nwafulive.webservice.airline.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getDomesticAirlinesTimeResult;

    public GetDomesticAirlinesTimeResponse() {
    }

    public GetDomesticAirlinesTimeResponse(
           cn.nwafulive.webservice.airline.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getDomesticAirlinesTimeResult) {
     ...
     */
    public cn.nwafulive.webservice.airline.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getGetDomesticAirlinesTimeResult() {
        return getDomesticAirlinesTimeResult;
    }
     ...
     */
    public void setGetDomesticAirlinesTimeResult(cn.nwafulive.webservice.airline.GetDomesticAirlinesTimeResponseGetDomesticAirlinesTimeResult getDomesticAirlinesTimeResult) {
        this.getDomesticAirlinesTimeResult = getDomesticAirlinesTimeResult;
    }
