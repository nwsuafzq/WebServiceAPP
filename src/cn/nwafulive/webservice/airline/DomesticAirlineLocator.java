...
public class DomesticAirlineLocator extends org.apache.axis.client.Service implements cn.nwafulive.webservice.airline.DomesticAirline {
 ...
 */
    ...
    public cn.nwafulive.webservice.airline.DomesticAirlineSoap_PortType getDomesticAirlineSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public cn.nwafulive.webservice.airline.DomesticAirlineSoap_PortType getDomesticAirlineSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.nwafulive.webservice.airline.DomesticAirlineSoap12Stub _stub = new cn.nwafulive.webservice.airline.DomesticAirlineSoap12Stub(portAddress, this);
    ...
    public cn.nwafulive.webservice.airline.DomesticAirlineSoap_PortType getDomesticAirlineSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public cn.nwafulive.webservice.airline.DomesticAirlineSoap_PortType getDomesticAirlineSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.nwafulive.webservice.airline.DomesticAirlineSoap_BindingStub _stub = new cn.nwafulive.webservice.airline.DomesticAirlineSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.nwafulive.webservice.airline.DomesticAirlineSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.nwafulive.webservice.airline.DomesticAirlineSoap12Stub _stub = new cn.nwafulive.webservice.airline.DomesticAirlineSoap12Stub(new java.net.URL(DomesticAirlineSoap12_address), this);
                _stub.setPortName(getDomesticAirlineSoap12WSDDServiceName());
                return _stub;
            }
            if (cn.nwafulive.webservice.airline.DomesticAirlineSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.nwafulive.webservice.airline.DomesticAirlineSoap_BindingStub _stub = new cn.nwafulive.webservice.airline.DomesticAirlineSoap_BindingStub(new java.net.URL(DomesticAirlineSoap_address), this);
                _stub.setPortName(getDomesticAirlineSoapWSDDServiceName());
                return _stub;
            }
        }
