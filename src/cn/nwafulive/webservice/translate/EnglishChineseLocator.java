...
public class EnglishChineseLocator extends org.apache.axis.client.Service implements cn.nwafulive.webservice.translate.EnglishChinese {
 ...
 */
    ...
    public cn.nwafulive.webservice.translate.EnglishChineseSoap_PortType getEnglishChineseSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public cn.nwafulive.webservice.translate.EnglishChineseSoap_PortType getEnglishChineseSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.nwafulive.webservice.translate.EnglishChineseSoap12Stub _stub = new cn.nwafulive.webservice.translate.EnglishChineseSoap12Stub(portAddress, this);
    ...
    public cn.nwafulive.webservice.translate.EnglishChineseSoap_PortType getEnglishChineseSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public cn.nwafulive.webservice.translate.EnglishChineseSoap_PortType getEnglishChineseSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.nwafulive.webservice.translate.EnglishChineseSoap_BindingStub _stub = new cn.nwafulive.webservice.translate.EnglishChineseSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.nwafulive.webservice.translate.EnglishChineseSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.nwafulive.webservice.translate.EnglishChineseSoap12Stub _stub = new cn.nwafulive.webservice.translate.EnglishChineseSoap12Stub(new java.net.URL(EnglishChineseSoap12_address), this);
                _stub.setPortName(getEnglishChineseSoap12WSDDServiceName());
                return _stub;
            }
            if (cn.nwafulive.webservice.translate.EnglishChineseSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.nwafulive.webservice.translate.EnglishChineseSoap_BindingStub _stub = new cn.nwafulive.webservice.translate.EnglishChineseSoap_BindingStub(new java.net.URL(EnglishChineseSoap_address), this);
                _stub.setPortName(getEnglishChineseSoapWSDDServiceName());
                return _stub;
            }
        }
